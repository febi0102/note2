...
class _EditState extends State<Edit> {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            ...
            "http://192.168.21.1/flutter/note_app/detail.php?id='${widget.id}'"),
        headers: {
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.21.1/flutter/note_app/update.php"),
        headers: {
          "Accept": "application/json",
          "Access-Control_Allow_Origin": "*"
        },
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.21.1/flutter/note_app/delete.php"),
        headers: {
          "Accept": "application/json",
          "Access-Control_Allow_Origin": "*"
        },
